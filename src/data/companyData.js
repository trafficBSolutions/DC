...
export const getCategorizedServiceTypes = () => {
  return {
    ...
    'Utility Work': ['Concrete Mixing', 'Material Hauling', 'Logistics Planning', 'Utility Infrastructure', 'Right-of-Way Acquisition', 'Land Surveying', 'Project Coordination', 'Energy Sector Services'],
...
export const getCompaniesByService = (serviceName) => {
  const companies = [
    ...
    { name: 'Fair`s Auto Service', services: ['Automotive Repair', 'Vehicle Maintenance', 'Brake Services', 'Engine Diagnostics'] },
    ...
    { name: 'Landscape Creations', services: ['Landscape Design', 'Construction', 'Hardscaping', 'Planting & Irrigation'] },
    { name: 'Muse Land Services LLC', services: ['Grading and Site Prep', 'Road and Parking', 'Drainage', 'Dump Truck Services', 'Utility Location', 'Land Clearing', 'Forestry Mulching', 'Erosion Control', 'Pond Construction'] },
    ...
    { name: 'Peel Aesthetics', services: ['Skincare', 'Aesthetics', 'Medical Spa', 'Wellness Services'] },
